...
func (_m *MockSceneTextAnalyzer) AnalyzeSceneText(ctx context.Context, sceneText string) ([]entity.Tag, error) {
...
func (_c *MockSceneTextAnalyzer_AnalyzeSceneText_Call) Return(_a0 []entity.Tag, _a1 error) *MockSceneTextAnalyzer_AnalyzeSceneText_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSceneTextAnalyzer_AnalyzeSceneText_Call) RunAndReturn(run func(context.Context, string) ([]entity.Tag, error)) *MockSceneTextAnalyzer_AnalyzeSceneText_Call {
	_c.Call.Return(run)
	return _c
}

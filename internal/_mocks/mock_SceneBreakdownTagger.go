...
// BreakdownScene provides a mock function with given fields: ctx, scenes, sceneBreakdowns
func (_m *MockSceneBreakdownTagger) BreakdownScene(ctx context.Context, scenes chan entity.Scene, sceneBreakdowns chan entity.SceneBreakdown) error {
	ret := _m.Called(ctx, scenes, sceneBreakdowns)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chan entity.Scene, chan entity.SceneBreakdown) error); ok {
		r0 = rf(ctx, scenes, sceneBreakdowns)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockSceneBreakdownTagger_Expecter) BreakdownScene(ctx interface{}, scenes interface{}, sceneBreakdowns interface{}) *MockSceneBreakdownTagger_BreakdownScene_Call {
	return &MockSceneBreakdownTagger_BreakdownScene_Call{Call: _e.mock.On("BreakdownScene", ctx, scenes, sceneBreakdowns)}
}

func (_c *MockSceneBreakdownTagger_BreakdownScene_Call) Run(run func(ctx context.Context, scenes chan entity.Scene, sceneBreakdowns chan entity.SceneBreakdown)) *MockSceneBreakdownTagger_BreakdownScene_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(chan entity.Scene), args[2].(chan entity.SceneBreakdown))
	})
	return _c
}
...
func (_c *MockSceneBreakdownTagger_BreakdownScene_Call) RunAndReturn(run func(context.Context, chan entity.Scene, chan entity.SceneBreakdown) error) *MockSceneBreakdownTagger_BreakdownScene_Call {
	_c.Call.Return(run)
	return _c
}
